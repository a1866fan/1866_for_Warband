...
skills = [
  ...
  ("reserved_13", "Stockpiling", sf_base_att_str, 10, "Allows the party to equip extended capacity ammunition bags, which hold additional pistol (+2) and rifle (+3) rounds per skill level. (Leader skill)"),
